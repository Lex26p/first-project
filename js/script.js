...
function grad1() {
  let grd = inW1.value;
  grd1 = grd;
  inW1.style.background = `linear-gradient(to right, #403e3e ${grd1}%, rgba(255, 255, 0, 0) 0%)`;
}

function grad2() {
  let grd = inW2.value;
  grd2 = grd;
  inW2.style.background = `linear-gradient(to right, #403e3e ${grd2}%, rgba(255, 255, 0, 0) 0%)`;
}
function grad3() {
  let grd = inW3.value;
  grd3 = grd;
  inW3.style.background = `linear-gradient(to right, #403e3e ${grd3}%, rgba(255, 255, 0, 0) 0%)`;
}
